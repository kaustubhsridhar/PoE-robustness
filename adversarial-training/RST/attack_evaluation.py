...
def eval_adv_test(model, device, test_loader, attack, attack_params,
    ...
    return 100 * num_correct_adv / count
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epsilon', default=8.0/255, type=float,
                        help='Attack perturbation magnitude') # previously, default=0.031
    ...
    parser.add_argument('--random_seed', default=1, type=int,
                        help='Random seed for permutation of test instances') # previously, default=0
